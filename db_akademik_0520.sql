...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Jan 2022 pada 15.58
...
--
-- Struktur dari tabel `tbl_students_0520`
--

CREATE TABLE `tbl_students_0520` (
  `ID` int(10) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_students_0520`
--

INSERT INTO `tbl_students_0520` (`ID`, `NIM`, `NAMA`, `JK`, `JURUSAN`, `ALAMAT`) VALUES
...
--
-- Indeks untuk tabel `tbl_students_0520`
--
ALTER TABLE `tbl_students_0520`
  ADD PRIMARY KEY (`ID`);
COMMIT;
